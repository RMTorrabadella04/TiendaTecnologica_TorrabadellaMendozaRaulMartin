...
public class Main extends javax.swing.JFrame {
    ...
    private void BotonUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonUsuarioActionPerformed
        ...
        // Añadir un WindowListener para detectar el cierre de la ventana de usuarios
        ventanaUsuarios.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent e) {
                // Hacer visible la ventana principal de nuevo cuando la ventana de usuarios se cierra
